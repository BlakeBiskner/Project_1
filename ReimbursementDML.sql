...
INSERT INTO DEPARTMENT VALUES(null, 'Writing');

SELECT * FROM APPLICATION_MATERIAL_REQUEST INNER JOIN APPLICATION_VIEW ON amr_a_id = a_id;
SELECT * FROM APPLICATION_VIEW;
SELECT * FROM USER_VIEW;
SELECT * FROM APPLICATION_APPROVAL;
