...
window.onload=function(){
    ...
    if(typeof(Storage)!="undefined"){
        ...
        for(i=0;i<reviewApps.length;i++){
            ...
            appTable+='<div class="form-row">';
            appTable+='<div class="form-group col-12">';
            appTable+='<button name="approve" input type="submit" value="'+reviewApps[i].applicationID+'" class="form-control btn-success" id="approveButton">Approve</button>';
            appTable+='</div>';
            appTable+='</div>';
            appTable+='</form>';
            ...
            appTable+='<div class="form-row">';
            appTable+='<div class="form-group col-12">';
            appTable+='<button name="approve" input type="submit" value="'+reviewApps[i].applicationID+'" class="form-control btn-danger" id="denyButton">Deny</button>';
            appTable+='</div>';
            appTable+='</div>';
            appTable+='</form>';
