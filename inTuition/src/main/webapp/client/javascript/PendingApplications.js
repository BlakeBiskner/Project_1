...
window.onload=function(){
    ...
    if(typeof(Storage)!="undefined"){
        ...
        for(i=0;i<reviewApps.length;i++){
            ...
            appTable+='<div class="form-row">';
            appTable+='<div class="form-group col-12">';
            appTable+='<input type="submit" name="approve" value="'+reviewApps[i].applicationID+'" class="form-control btn-success" id="approveButton">';
            appTable+='</div>';
            appTable+='</div>';
            appTable+='</form>';
            ...
            appTable+='<form class="col-12">';
            appTable+='<div class="form-row">';
            appTable+='<div class="form-group col-12" method="POST" action="Deny.do">';
